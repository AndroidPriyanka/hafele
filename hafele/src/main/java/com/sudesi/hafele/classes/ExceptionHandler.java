...
public class ExceptionHandler implements java.lang.Thread.UncaughtExceptionHandler {
    ...
    public void createNotification(Context context, String log) {
        ...
        String applicationName =  "Hafele"; //context.getResources().getString("");

        CharSequence tickerText = "Hafele" + " error";
        long when = System.currentTimeMillis();

        String subject = "Hafele"+ " -" + CRASH_LOG_MAIL_SUBJECT;
        String body = CRASH_LOG_MAIL_BODY + "\n" + log;

        Intent sendIntent = new Intent(Intent.ACTION_SEND);

        String[] strEmails = new String[]{
                "aniketadsul@sudesi.in",
        };
      //  Bitmap largeIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.splash_logo);
