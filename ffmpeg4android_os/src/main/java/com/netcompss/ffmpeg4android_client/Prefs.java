...
public class Prefs {
	...
	public static final String DEFAULT_OUT_FOLDER = "/sdcard/Android/data/qwerty/sd23/asdf/";
//	public static final String DEFAULT_OUT_FOLDER = "/sdcard/videokit/";
//	public static final String DEFAULT_WORK_FOLDER = "/sdcard/videokit/";
	public static final String DEFAULT_WORK_FOLDER = "/sdcard/Android/data/qwerty/sd23/asdf/";
	...
	*/
	...
	public static String getWorkingFolderForNative() {
		...
		Log.e("WorkingFolder For Native", getWorkFolder().substring(0, getWorkFolder().length() - 1));
